...
void deel5(){
	// Redelijk tegendraadse afspraak, maar niettemin
	// afspraak: de prefixoperator ++ zal de TELLER omhoog zetten;
	// de postfixoperator ++ zal de NOEMER omhoog zetten.
	// Dus ++(2/5) levert 3/5 (op diezelfde regel code)
	// en (2/5)++ levert 2/6 (maar wel pas vanop de volgende regel code).
	Breuk a(3,4);
	cout << " a: " << a << endl;
	for(int i=0; i<5; i++){
		cout << " a++: " << a++;
